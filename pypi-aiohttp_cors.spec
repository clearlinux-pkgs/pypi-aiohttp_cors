...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707109507
...
cp %{_builddir}/aiohttp-cors-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-aiohttp_cors/25d1ec1e682bcde600e2e1e0a043ea705de7f30d || :
